...
- **Coverage** `window::find::scope::tests`; `window::find::bartests::search_in_selection_confines_the_editor_search_and_its_replacements`, `…::the_editor_lights_only_the_matches_inside_the_passage`, `…::a_preview_scope_that_no_longer_resolves_turns_itself_off`, `…::the_in_selection_control_is_unavailable_with_nothing_to_confine`; `tests/MANUAL-TEST.md` §11.17–§11.19
