...
//! in `renderer::start` (WP7b, sdd/PLAN.memory-gates.md). [`visibility`] is the
//! "can anyone see this picture right now?" decision (WP8) — scroll viewport,
...
//! reimplemented) for a THEME sprite (WP10, TDD 27.9) — a decoration the preview's
